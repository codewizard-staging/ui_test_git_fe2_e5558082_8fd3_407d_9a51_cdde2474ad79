...
const GetPetCareCenterImagesJoin = async (id, filter) => {     return new Promise(async (resolve) => {
...
export {
 GetEntityInfo,  GetPetServicesCount, GetPetServicesMulti, GetPetServiceSingle, SetPetServiceSingle, GetPetOwnersCount, GetPetOwnersMulti, GetPetOwnerSingle, SetPetOwnerSingle, GetPetCareCentersCount, GetPetCareCentersMulti, GetPetCareCenterSingle, SetPetCareCenterSingle, SetPetCareCenterImagesJoin, GetPetCareCenterImagesJoin, SetDocumentSingleMedia, GetDocumentSingleMedia, GetPetsCount, GetPetsMulti, GetPetSingle, SetPetSingle, GetProductStatus, GetMetaData, GetProductOnBoardings
};